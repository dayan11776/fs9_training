...
from .models import Product, shippingsAddress, orderItem, paymentMethod
...
class PaymentMethodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = paymentMethod
        fields = ['id', 'totalPrice', 'isPaid', 'paidAt', 'xendit_invoice_id', 'xendit_external_id', 'xendit_status', 'items', 'shipping']
    ...
    def get_shipping(self, obj):
        addr = shippingsAddress.objects.filter(paymentId=obj).first()
        if addr:
